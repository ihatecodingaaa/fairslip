...
const en = {
  ...
  /* ------------------------------------------------------- the payroll X-ray */
  /* One dominant picture at a time, and the words that name it. The prose that
     used to sit between the summary and the grid is gone: the lens names say
     what each view is for, and the inspector says what a row is. */
  "employer.xray": "Payroll X-ray",
  "employer.lensLabel": "X-ray view",
  "employer.lensStatus": "Status",
  "employer.lensDifference": "Difference",
  "employer.lensReasons": "Reasons",
  "employer.lensRows": "Rows",
  "employer.rowsRead": "Rows read",
  "employer.checkedRows": "Checked",
  "employer.exceptionRows": "Exceptions",
  "employer.headline": "Difference across the rows that were checked",
  "employer.declaredTotal": "Declared in the file",
  "employer.expectedTotal": "The published rules give",
  "employer.bridgeRows": "across {n} checked rows",
  "employer.bridgeRefused": "{n} rows were not checked and are in neither total",
  "employer.skyline": "Difference by row",
  "employer.skylineAlt": "Signed difference for each of {n} checked rows, around a zero line.",
  "employer.skylineAbove": "Declared more than the rules give",
  "employer.skylineBelow": "Declared less than the rules give",
  "employer.skylineLane": "Not checked - no amount was computed",
  "employer.skylineScale": "Tallest bar",
  "employer.skylineFlat": "Every checked row matched, so there is nothing to scale against.",
  "employer.keyboardHintRow": "Left and right arrow keys move between rows.",
  "employer.order": "Order",
  "employer.orderFile": "File order",
  "employer.orderLargest": "Largest difference",
  "employer.reasonsHeading": "Where the difference comes from",
  "employer.reasonRows": "{n} rows",
  "employer.reasonNotChecked": "not checked, no amount",
  "employer.downloadSvg": "Download SVG",
  "employer.inspectorDeclared": "Declared",
  "employer.inspectorExpected": "Rules give",
  "employer.inspectorDifference": "Difference",
  "employer.inspectorOutcome": "Outcome",
  "employer.inspectorWhy": "Why",
  "employer.inspectorTechnical": "Wage, formula and flags",
  "employer.inspectorWage": "Ordinary Wages",
  "employer.inspectorBand": "CPF age band",
  "employer.inspectorNotComputed": "not computed",
  "employer.rowsExceptions": "Exceptions",
  "employer.rowsNotChecked": "Not checked",
  "employer.rowsMatched": "Matched",
  "employer.showMore": "Show {n} more",
  /* The engine's own reason codes, read aloud. The code is shown beside every
     one of these on screen, so the sentence explains it rather than replacing
     it. app/employer/reasons.ts holds the mapping; a backend test asserts it
     covers every member of the Reason enum. */
  "employer.reasonAmountMismatch": "Declared amount differs from the published rates",
  "employer.reasonAgeBand": "Age group changed and the old rate was used",
  "employer.reasonCeiling": "Ordinary Wages above the ceiling",
  "employer.reasonNotMember": "CPF declared for someone who is not a CPF member",
  "employer.reasonEngineRefused": "FairSlip will not compute this case",
  "employer.reasonAdditionalWages": "Additional Wages present - outside what FairSlip checks",
  "employer.reasonUnreadable": "The row could not be read",
  "employer.reasonUnknown": "A reason code this screen has no words for",
  /* --------------------------------------------------------------- recheck */
  /* The employer fixed the payroll in their own system and exported it again.
     Every word here describes what the ARITHMETIC found between the two runs -
     never what FairSlip did, and never money anyone has yet paid. */
  "recheck.heading": "Before and after",
  "recheck.start": "Check a corrected file",
  "recheck.startDemo": "Run the corrected roster",
  "recheck.explain": "Upload the file your payroll system exported after the fix. FairSlip runs the same check again and compares the two.",
  "recheck.before": "First file",
  "recheck.after": "Corrected file",
  "recheck.matchedOn": "Rows are matched on the CPF account number, so a re-ordered export still compares the same employee.",
  "recheck.comparableRows": "Across the {n} rows checked in both runs, the total difference moved from {a} to {b}.",
  "recheck.absentFromFile": "not in this file",
  "recheck.rowNowMatches": "This row now matches the checked rule.",
  "recheck.stillDiffers": "This row still differs from the checked rule.",
  "recheck.leave": "Back to the single-file check",
  "recheck.grids": "Every row, in both files",
  "recheck.gridNote": "The same employee is in the same position in both grids.",
  /* The ten states. Each is a fact about two runs, not a verdict on anyone. */
  "recheck.STILL_MATCHED": "matched in both runs",
  "recheck.RESOLVED": "now matches",
  "recheck.STILL_EXCEPTION": "still differs",
  "recheck.NEW_EXCEPTION": "differs now, matched before",
  "recheck.NEWLY_REFUSED": "was checked before, cannot be checked now",
  "recheck.STILL_REFUSED": "not checked in either run",
  "recheck.NEWLY_CHECKED_MATCHED": "checked this time, and it matches",
  "recheck.NEWLY_CHECKED_EXCEPTION": "checked this time, and it differs",
  "recheck.REMOVED": "in the first file only",
  "recheck.ADDED": "in the corrected file only",
  /* ---------------------------------------------------------- report studio */
  /* The audience leads, because a board paper, a payroll worklist and a file
     for a reviewer are three documents from one run. Nothing here is called a
     certificate, an opinion or an approval - see report/Preview.tsx. */
  "report.heading": "Build a review pack",
  "report.open": "Build a review pack",
  "report.leave": "Back to the payroll X-ray",
  "report.audience": "Who is reading it",
  "report.execName": "Executive",
  "report.execHint": "One page. What was checked, how much, and what kind.",
  "report.opsName": "Payroll ops",
  "report.opsHint": "Every row that needs looking at.",
  "report.auditName": "Audit / review",
  "report.auditHint": "Coverage, method and every checked row.",
  "report.customName": "Custom",
  "report.customHint": "Choose the sections yourself.",
  "report.modules": "Sections",
  "report.alwaysIncluded": "Always included. Every figure in the pack is a claim about the rows that were checked.",
  "report.needsRecheck": "Available once a corrected file has been checked.",
  "report.privacy": "Identity",
  "report.privAnon": "Row numbers only",
  "report.privAnonHint": "No name and no account number.",
  "report.privAccount": "Masked account number",
  "report.privAccountHint": "Enough to find the row in your own system.",
  "report.privFull": "Names and account numbers",
  "report.privFullHint": "Exactly as the uploaded file carried them.",
  "report.take": "Take it away",
  "report.print": "Print / Save as PDF",
  "report.excel": "Excel workbook (.xlsx)",
  "report.preparing": "Preparing…",
  "report.json": "JSON",
  "report.csv": "CSV",
  "report.csvExceptions": "Exceptions only",
  "report.csvNotChecked": "Not checked",
  "report.csvAll": "All rows",
  "report.csvRows": "{n} rows",
  "report.csvDownload": "Download CSV",
  "report.advanced": "Advanced",
  "report.markdown": "Markdown",
  "report.exportFailed": "The file was not written.",
  /* ------------------------------------------------------------- focus mode */
  ...
  "focus.back": "Back",
  "focus.skip": "Skip for now",
  "focus.next": "Next",
  "focus.allAnswered": "Everything has been answered.",
  "focus.allAnsweredNote": "{n} of {t} facts from your documents are settled, and you have answered the rest.",
  /* ------------------------------------------------------------ result lenses */
  "lens.summary": "Summary",
  "lens.trail": "Money trail",
  "lens.evidence": "Evidence",
  "lens.next": "What next",
  "lens.pick": "What to look at",
  /* ------------------------------------------------------- the evidence pack */
  /* What a worker carries out of the building. Every line about what it is NOT
     is load-bearing: they are about to hand it to somebody with authority over
     them, and anything it does not say is something that might be assumed. */
  "pack.heading": "Take this with you",
  ...
  "pack.json": "Download the facts",
  "pack.notTitle": "What this is not",
  "pack.notClaim": "It is not a claim. Nothing has been filed, and FairSlip files nothing.",
  "pack.notProof": "It is not proof. It is your own documents, read, with the published rules applied to them.",
...
const zh: Partial<Record<Key, string>> = {
  ...
  /* ------------------------------------------------------- the payroll X-ray */
  "employer.xray": "薪资透视",
  "employer.lensLabel": "透视视图",
  "employer.lensStatus": "状态",
  "employer.lensDifference": "差额",
  "employer.lensReasons": "原因",
  "employer.lensRows": "逐行",
  "employer.rowsRead": "读取行数",
  "employer.checkedRows": "已检查",
  "employer.exceptionRows": "异常",
  "employer.headline": "已检查各行的差额合计",
  "employer.declaredTotal": "文件中申报的金额",
  "employer.expectedTotal": "按公布规则应为",
  "employer.bridgeRows": "涵盖 {n} 个已检查的行",
  "employer.bridgeRefused": "有 {n} 行未被检查，两项合计均不包含它们",
  "employer.skyline": "逐行差额",
  "employer.skylineAlt": "{n} 个已检查行各自的带符号差额，以零线为基准。",
  "employer.skylineAbove": "申报高于公布规则",
  "employer.skylineBelow": "申报低于公布规则",
  "employer.skylineLane": "未检查——没有计算任何金额",
  "employer.skylineScale": "最高的一条",
  "employer.skylineFlat": "每个已检查的行都相符，因此没有可作比例的数值。",
  "employer.keyboardHintRow": "用左右方向键在各行之间移动。",
  "employer.order": "排序",
  "employer.orderFile": "文件顺序",
  "employer.orderLargest": "差额由大到小",
  "employer.reasonsHeading": "差额来自哪里",
  "employer.reasonRows": "{n} 行",
  "employer.reasonNotChecked": "未检查，没有金额",
  "employer.downloadSvg": "下载 SVG",
  "employer.inspectorDeclared": "申报",
  "employer.inspectorExpected": "规则应为",
  "employer.inspectorDifference": "差额",
  "employer.inspectorOutcome": "结果",
  "employer.inspectorWhy": "原因",
  "employer.inspectorTechnical": "工资、公式与标记",
  "employer.inspectorWage": "普通工资",
  "employer.inspectorBand": "公积金年龄段",
  "employer.inspectorNotComputed": "未计算",
  "employer.rowsExceptions": "异常",
  "employer.rowsNotChecked": "未检查",
  "employer.rowsMatched": "相符",
  "employer.showMore": "再显示 {n} 行",
  "employer.reasonAmountMismatch": "申报金额与公布的缴费率不符",
  "employer.reasonAgeBand": "年龄段已变更，仍沿用旧的缴费率",
  "employer.reasonCeiling": "普通工资超出上限",
  "employer.reasonNotMember": "为非公积金会员申报了公积金",
  "employer.reasonEngineRefused": "FairSlip 不计算此情况",
  "employer.reasonAdditionalWages": "存在额外工资——超出 FairSlip 的检查范围",
  "employer.reasonUnreadable": "该行无法读取",
  "employer.reasonUnknown": "本页面尚无对应说明的原因代码",
  /* --------------------------------------------------------------- recheck */
  "recheck.heading": "前后对照",
  "recheck.start": "检查更正后的文件",
  "recheck.startDemo": "运行更正后的名册",
  "recheck.explain": "上传贵司薪资系统更正后导出的文件。FairSlip 会再检查一次，并将两次结果作比较。",
  "recheck.before": "第一份文件",
  "recheck.after": "更正后的文件",
  "recheck.matchedOn": "各行以公积金账号配对，因此即使导出顺序不同，比较的仍是同一位员工。",
  "recheck.comparableRows": "在两次都检查过的 {n} 行中，差额合计由 {a} 变为 {b}。",
  "recheck.absentFromFile": "不在此文件中",
  "recheck.rowNowMatches": "此行现已与所检查的规则一致。",
  "recheck.stillDiffers": "此行仍与所检查的规则不符。",
  "recheck.leave": "返回单一文件检查",
  "recheck.grids": "两份文件中的每一行",
  "recheck.gridNote": "同一位员工在两个网格中位置相同。",
  "recheck.STILL_MATCHED": "两次都相符",
  "recheck.RESOLVED": "现已相符",
  "recheck.STILL_EXCEPTION": "仍然不符",
  "recheck.NEW_EXCEPTION": "此次不符，上次相符",
  "recheck.NEWLY_REFUSED": "上次可检查，此次无法检查",
  "recheck.STILL_REFUSED": "两次都未检查",
  "recheck.NEWLY_CHECKED_MATCHED": "此次已检查，结果相符",
  "recheck.NEWLY_CHECKED_EXCEPTION": "此次已检查，结果不符",
  "recheck.REMOVED": "仅在第一份文件中",
  "recheck.ADDED": "仅在更正后的文件中",
  /* ---------------------------------------------------------- report studio */
  "report.heading": "生成审阅包",
  "report.open": "生成审阅包",
  "report.leave": "返回薪资透视",
  "report.audience": "给谁看",
  "report.execName": "管理层",
  "report.execHint": "一页纸：检查了什么、金额多少、属于哪一类。",
  "report.opsName": "薪资作业",
  "report.opsHint": "每一行需要处理的记录。",
  "report.auditName": "审计／复核",
  "report.auditHint": "覆盖范围、方法，以及每一个已检查的行。",
  "report.customName": "自定义",
  "report.customHint": "自行选择章节。",
  "report.modules": "章节",
  "report.alwaysIncluded": "始终包含。包内每一个数字都是关于已检查各行的陈述。",
  "report.needsRecheck": "检查过更正后的文件后即可使用。",
  "report.privacy": "身份信息",
  "report.privAnon": "仅显示行号",
  "report.privAnonHint": "不含姓名，也不含账号。",
  "report.privAccount": "部分遮蔽的账号",
  "report.privAccountHint": "足以在贵司系统中找到该行。",
  "report.privFull": "姓名与账号",
  "report.privFullHint": "与上传文件中的内容完全一致。",
  "report.take": "带走文件",
  "report.print": "打印／另存为 PDF",
  "report.excel": "Excel 工作簿（.xlsx）",
  "report.preparing": "正在准备…",
  "report.json": "JSON",
  "report.csv": "CSV",
  "report.csvExceptions": "仅异常行",
  "report.csvNotChecked": "未检查的行",
  "report.csvAll": "全部行",
  "report.csvRows": "{n} 行",
  "report.csvDownload": "下载 CSV",
  "report.advanced": "进阶",
  "report.markdown": "Markdown",
  ...
  "focus.skip": "暂时跳过",
  "focus.next": "下一题",
  "focus.allAnswered": "全部问题都已回答。",
  "focus.allAnsweredNote": "文件中 {t} 项事实已确定 {n} 项，其余由您回答。",
  /* ------------------------------------------------------------ result lenses */
  "lens.summary": "摘要",
  "lens.trail": "金额来源",
  "lens.evidence": "证据",
  ...
  "pack.json": "下载这些事实",
  "pack.notTitle": "这不是什么",
  "pack.notClaim": "这不是索赔。没有提交任何申请，FairSlip 也不会代为提交。",
  "pack.notProof": "这不是证据裁定。它是您自己的文件经读取后，按公布规则计算的结果。",
...
const bn: Partial<Record<Key, string>> = {
  ...
  /* ------------------------------------------------------- the payroll X-ray */
  "employer.xray": "পে-রোল এক্স-রে",
  "employer.lensLabel": "এক্স-রে দৃশ্য",
  "employer.lensStatus": "অবস্থা",
  "employer.lensDifference": "পার্থক্য",
  "employer.lensReasons": "কারণ",
  "employer.lensRows": "সারি",
  "employer.rowsRead": "পড়া সারি",
  "employer.checkedRows": "পরীক্ষা করা হয়েছে",
  "employer.exceptionRows": "ব্যতিক্রম",
  "employer.headline": "যে সারিগুলি পরীক্ষা করা হয়েছে, তাদের মোট পার্থক্য",
  "employer.declaredTotal": "ফাইলে ঘোষিত",
  "employer.expectedTotal": "প্রকাশিত নিয়ম অনুযায়ী",
  "employer.bridgeRows": "{n}টি পরীক্ষিত সারি জুড়ে",
  "employer.bridgeRefused": "{n}টি সারি পরীক্ষা করা হয়নি এবং কোনও মোটেই ধরা নেই",
  "employer.skyline": "সারি অনুযায়ী পার্থক্য",
  "employer.skylineAlt": "শূন্য রেখার চারপাশে {n}টি পরীক্ষিত সারির চিহ্নসহ পার্থক্য।",
  "employer.skylineAbove": "প্রকাশিত নিয়মের চেয়ে বেশি ঘোষণা করা হয়েছে",
  "employer.skylineBelow": "প্রকাশিত নিয়মের চেয়ে কম ঘোষণা করা হয়েছে",
  "employer.skylineLane": "পরীক্ষা করা হয়নি - কোনও অঙ্ক কষা হয়নি",
  "employer.skylineScale": "সবচেয়ে লম্বা দণ্ড",
  "employer.skylineFlat": "প্রতিটি পরীক্ষিত সারি মিলে গেছে, তাই মাপার মতো কিছু নেই।",
  "employer.keyboardHintRow": "বাঁ ও ডান তীর-চিহ্নের কী দিয়ে সারির মধ্যে যান।",
  "employer.order": "ক্রম",
  "employer.orderFile": "ফাইলের ক্রম",
  "employer.orderLargest": "সবচেয়ে বড় পার্থক্য",
  "employer.reasonsHeading": "পার্থক্যটি কোথা থেকে আসছে",
  "employer.reasonRows": "{n}টি সারি",
  "employer.reasonNotChecked": "পরীক্ষা করা হয়নি, কোনও অঙ্ক নেই",
  "employer.downloadSvg": "SVG ডাউনলোড করুন",
  "employer.inspectorDeclared": "ঘোষিত",
  "employer.inspectorExpected": "নিয়ম অনুযায়ী",
  "employer.inspectorDifference": "পার্থক্য",
  "employer.inspectorOutcome": "ফলাফল",
  "employer.inspectorWhy": "কেন",
  "employer.inspectorTechnical": "মজুরি, সূত্র ও চিহ্ন",
  "employer.inspectorWage": "সাধারণ মজুরি",
  "employer.inspectorBand": "CPF বয়স-স্তর",
  "employer.inspectorNotComputed": "কষা হয়নি",
  "employer.rowsExceptions": "ব্যতিক্রম",
  "employer.rowsNotChecked": "পরীক্ষা করা হয়নি",
  "employer.rowsMatched": "মিলেছে",
  "employer.showMore": "আরও {n}টি দেখান",
  "employer.reasonAmountMismatch": "ঘোষিত অঙ্ক প্রকাশিত হারের সঙ্গে মেলেনি",
  "employer.reasonAgeBand": "বয়স-স্তর বদলেছে, পুরনো হারই ব্যবহার হয়েছে",
  "employer.reasonCeiling": "সাধারণ মজুরি সর্বোচ্চ সীমার উপরে",
  "employer.reasonNotMember": "যিনি CPF সদস্য নন, তাঁর জন্য CPF ঘোষণা করা হয়েছে",
  "employer.reasonEngineRefused": "FairSlip এই ক্ষেত্রটি হিসাব করবে না",
  "employer.reasonAdditionalWages": "অতিরিক্ত মজুরি আছে - FairSlip যা দেখে তার বাইরে",
  "employer.reasonUnreadable": "সারিটি পড়া যায়নি",
  "employer.reasonUnknown": "এই পর্দায় যে কারণ-কোডের জন্য কোনও কথা নেই",
  /* --------------------------------------------------------------- recheck */
  "recheck.heading": "আগে ও পরে",
  "recheck.start": "সংশোধিত ফাইল পরীক্ষা করুন",
  "recheck.startDemo": "সংশোধিত তালিকাটি চালান",
  "recheck.explain": "সংশোধনের পর আপনার পে-রোল সিস্টেম যে ফাইলটি রপ্তানি করেছে সেটি দিন। FairSlip আবার একই পরীক্ষা চালিয়ে দুটির তুলনা করবে।",
  "recheck.before": "প্রথম ফাইল",
  "recheck.after": "সংশোধিত ফাইল",
  "recheck.matchedOn": "সারিগুলি CPF অ্যাকাউন্ট নম্বর দিয়ে মেলানো হয়, তাই ক্রম বদলে গেলেও একই কর্মীর তুলনাই হয়।",
  "recheck.comparableRows": "দুই বারেই পরীক্ষা করা {n}টি সারিতে মোট পার্থক্য {a} থেকে {b}-তে গিয়েছে।",
  "recheck.absentFromFile": "এই ফাইলে নেই",
  "recheck.rowNowMatches": "এই সারিটি এখন পরীক্ষিত নিয়মের সঙ্গে মিলছে।",
  "recheck.stillDiffers": "এই সারিটি এখনও পরীক্ষিত নিয়মের সঙ্গে মিলছে না।",
  "recheck.leave": "একক ফাইলের পরীক্ষায় ফিরুন",
  "recheck.grids": "দুই ফাইলের প্রতিটি সারি",
  "recheck.gridNote": "একই কর্মী দুই গ্রিডেই একই জায়গায় আছেন।",
  "recheck.STILL_MATCHED": "দুই বারেই মিলেছে",
  "recheck.RESOLVED": "এখন মিলছে",
  "recheck.STILL_EXCEPTION": "এখনও মিলছে না",
  "recheck.NEW_EXCEPTION": "এবার মিলছে না, আগে মিলেছিল",
  "recheck.NEWLY_REFUSED": "আগে পরীক্ষা করা গিয়েছিল, এখন যায় না",
  "recheck.STILL_REFUSED": "কোনও বারেই পরীক্ষা করা হয়নি",
  "recheck.NEWLY_CHECKED_MATCHED": "এবার পরীক্ষা হয়েছে, এবং মিলেছে",
  "recheck.NEWLY_CHECKED_EXCEPTION": "এবার পরীক্ষা হয়েছে, এবং মেলেনি",
  "recheck.REMOVED": "কেবল প্রথম ফাইলে",
  "recheck.ADDED": "কেবল সংশোধিত ফাইলে",
  /* ---------------------------------------------------------- report studio */
  "report.heading": "পর্যালোচনার প্যাক তৈরি করুন",
  "report.open": "পর্যালোচনার প্যাক তৈরি করুন",
  "report.leave": "পে-রোল এক্স-রে-তে ফিরুন",
  "report.audience": "কে পড়বেন",
  "report.execName": "ব্যবস্থাপনা",
  "report.execHint": "এক পাতা। কী পরীক্ষা হয়েছে, কত টাকা, কোন ধরনের।",
  "report.opsName": "পে-রোল দল",
  "report.opsHint": "যে সারিগুলিতে কাজ দরকার, তার প্রতিটি।",
  "report.auditName": "নিরীক্ষা / পর্যালোচনা",
  "report.auditHint": "পরিধি, পদ্ধতি এবং পরীক্ষিত প্রতিটি সারি।",
  "report.customName": "নিজের মতো",
  "report.customHint": "নিজেই অংশগুলি বেছে নিন।",
  "report.modules": "অংশ",
  "report.alwaysIncluded": "সর্বদা থাকে। প্যাকের প্রতিটি অঙ্ক পরীক্ষিত সারিগুলি সম্পর্কেই বলা।",
  "report.needsRecheck": "সংশোধিত ফাইল পরীক্ষা করার পরে পাওয়া যাবে।",
  "report.privacy": "পরিচয়",
  "report.privAnon": "শুধু সারি নম্বর",
  "report.privAnonHint": "নাম নেই, অ্যাকাউন্ট নম্বরও নেই।",
  "report.privAccount": "আংশিক ঢাকা অ্যাকাউন্ট নম্বর",
  "report.privAccountHint": "নিজেদের সিস্টেমে সারিটি খুঁজে পাওয়ার মতো যথেষ্ট।",
  "report.privFull": "নাম ও অ্যাকাউন্ট নম্বর",
  "report.privFullHint": "আপলোড করা ফাইলে যেমন ছিল, ঠিক তেমনই।",
  "report.take": "সঙ্গে নিয়ে যান",
  "report.print": "প্রিন্ট / PDF হিসেবে সংরক্ষণ",
  "report.excel": "Excel ওয়ার্কবুক (.xlsx)",
  "report.preparing": "তৈরি হচ্ছে…",
  "report.json": "JSON",
  "report.csv": "CSV",
  "report.csvExceptions": "শুধু ব্যতিক্রম",
  "report.csvNotChecked": "পরীক্ষা করা হয়নি",
  "report.csvAll": "সব সারি",
  "report.csvRows": "{n}টি সারি",
  "report.csvDownload": "CSV ডাউনলোড করুন",
  "report.advanced": "উন্নত",
  "report.markdown": "Markdown",
  ...
  "focus.back": "পিছনে",
  "focus.skip": "আপাতত বাদ দিন",
  "focus.next": "পরবর্তী",
  "focus.allAnswered": "সব প্রশ্নের উত্তর হয়ে গেছে।",
  "focus.allAnsweredNote": "আপনার নথি থেকে {t}টির মধ্যে {n}টি তথ্য নিশ্চিত, বাকিগুলি আপনি জানিয়েছেন।",
  /* ------------------------------------------------------------ result lenses */
  "lens.summary": "সারসংক্ষেপ",
  "lens.trail": "টাকার পথ",
  "lens.evidence": "প্রমাণ",
  "lens.next": "এরপর কী",
  "lens.pick": "কী দেখবেন",
  /* ------------------------------------------------------- the evidence pack */
  "pack.heading": "এটি সঙ্গে নিয়ে যান",
  ...
  "pack.json": "তথ্যগুলি ডাউনলোড করুন",
  "pack.notTitle": "এটি যা নয়",
  "pack.notClaim": "এটি কোনও দাবি নয়। কিছুই দাখিল করা হয়নি, এবং FairSlip কিছু দাখিল করে না।",
  "pack.notProof": "এটি প্রমাণ নয়। এটি আপনারই নথি, পড়া হয়েছে, তাতে প্রকাশিত নিয়ম প্রয়োগ করা হয়েছে।",
...
const ta: Partial<Record<Key, string>> = {
  ...
  /* ------------------------------------------------------- the payroll X-ray */
  "employer.xray": "ஊதியப் பட்டியல் எக்ஸ்-ரே",
  "employer.lensLabel": "எக்ஸ்-ரே காட்சி",
  "employer.lensStatus": "நிலை",
  "employer.lensDifference": "வேறுபாடு",
  "employer.lensReasons": "காரணங்கள்",
  "employer.lensRows": "வரிகள்",
  "employer.rowsRead": "படித்த வரிகள்",
  "employer.checkedRows": "சரிபார்க்கப்பட்டவை",
  "employer.exceptionRows": "விதிவிலக்குகள்",
  "employer.headline": "சரிபார்க்கப்பட்ட வரிகளின் மொத்த வேறுபாடு",
  "employer.declaredTotal": "கோப்பில் அறிவிக்கப்பட்டது",
  "employer.expectedTotal": "வெளியிடப்பட்ட விதிகள் தருவது",
  "employer.bridgeRows": "{n} சரிபார்க்கப்பட்ட வரிகளில்",
  "employer.bridgeRefused": "{n} வரிகள் சரிபார்க்கப்படவில்லை; இரு தொகையிலும் அவை இல்லை",
  "employer.skyline": "வரிவாரியான வேறுபாடு",
  "employer.skylineAlt": "பூஜ்ஜியக் கோட்டைச் சுற்றி {n} சரிபார்க்கப்பட்ட வரிகளின் குறியிட்ட வேறுபாடு.",
  "employer.skylineAbove": "விதிகள் தருவதைவிட அதிகமாக அறிவிக்கப்பட்டது",
  "employer.skylineBelow": "விதிகள் தருவதைவிட குறைவாக அறிவிக்கப்பட்டது",
  "employer.skylineLane": "சரிபார்க்கப்படவில்லை - எந்தத் தொகையும் கணக்கிடப்படவில்லை",
  "employer.skylineScale": "மிக உயரமான பட்டை",
  "employer.skylineFlat": "சரிபார்க்கப்பட்ட ஒவ்வொரு வரியும் பொருந்தியது, எனவே அளவிட எதுவும் இல்லை.",
  "employer.keyboardHintRow": "இடது-வலது அம்புக் குறி விசைகள் வரிகளுக்கு இடையே நகர்த்தும்.",
  "employer.order": "வரிசை",
  "employer.orderFile": "கோப்பு வரிசை",
  "employer.orderLargest": "பெரிய வேறுபாடு முதலில்",
  "employer.reasonsHeading": "வேறுபாடு எங்கிருந்து வருகிறது",
  "employer.reasonRows": "{n} வரிகள்",
  "employer.reasonNotChecked": "சரிபார்க்கப்படவில்லை, தொகை இல்லை",
  "employer.downloadSvg": "SVG பதிவிறக்கு",
  "employer.inspectorDeclared": "அறிவிக்கப்பட்டது",
  "employer.inspectorExpected": "விதிகள் தருவது",
  "employer.inspectorDifference": "வேறுபாடு",
  "employer.inspectorOutcome": "முடிவு",
  "employer.inspectorWhy": "ஏன்",
  "employer.inspectorTechnical": "ஊதியம், வாய்ப்பாடு, கொடிகள்",
  "employer.inspectorWage": "சாதாரண ஊதியம்",
  "employer.inspectorBand": "CPF வயது நிலை",
  "employer.inspectorNotComputed": "கணக்கிடப்படவில்லை",
  "employer.rowsExceptions": "விதிவிலக்குகள்",
  "employer.rowsNotChecked": "சரிபார்க்கப்படவில்லை",
  "employer.rowsMatched": "பொருந்தியவை",
  "employer.showMore": "மேலும் {n} காட்டு",
  "employer.reasonAmountMismatch": "அறிவித்த தொகை வெளியிடப்பட்ட விகிதங்களுடன் பொருந்தவில்லை",
  "employer.reasonAgeBand": "வயது நிலை மாறியது, பழைய விகிதமே பயன்படுத்தப்பட்டது",
  "employer.reasonCeiling": "சாதாரண ஊதியம் உச்ச வரம்பைத் தாண்டியது",
  "employer.reasonNotMember": "CPF உறுப்பினர் அல்லாதவருக்கு CPF அறிவிக்கப்பட்டுள்ளது",
  "employer.reasonEngineRefused": "இந்த வழக்கை FairSlip கணக்கிடாது",
  "employer.reasonAdditionalWages": "கூடுதல் ஊதியம் உள்ளது - FairSlip சரிபார்ப்பதற்கு வெளியே",
  "employer.reasonUnreadable": "இந்த வரியைப் படிக்க முடியவில்லை",
  "employer.reasonUnknown": "இந்தத் திரையில் சொற்கள் இல்லாத ஒரு காரணக் குறியீடு",
  /* --------------------------------------------------------------- recheck */
  "recheck.heading": "முன்பும் பின்பும்",
  "recheck.start": "திருத்திய கோப்பைச் சரிபார்",
  "recheck.startDemo": "திருத்திய பட்டியலை இயக்கு",
  "recheck.explain": "திருத்தத்திற்குப் பிறகு உங்கள் ஊதிய அமைப்பு ஏற்றுமதி செய்த கோப்பைக் கொடுங்கள். FairSlip அதே சோதனையை மீண்டும் இயக்கி இரண்டையும் ஒப்பிடும்.",
  "recheck.before": "முதல் கோப்பு",
  "recheck.after": "திருத்திய கோப்பு",
  "recheck.matchedOn": "வரிகள் CPF கணக்கு எண்ணால் இணைக்கப்படுகின்றன; எனவே வரிசை மாறினாலும் ஒப்பிடப்படுவது அதே ஊழியரே.",
  "recheck.comparableRows": "இரு முறையும் சரிபார்க்கப்பட்ட {n} வரிகளில், மொத்த வேறுபாடு {a}-லிருந்து {b}-ஆக மாறியது.",
  "recheck.absentFromFile": "இந்தக் கோப்பில் இல்லை",
  "recheck.rowNowMatches": "இந்த வரி இப்போது சரிபார்க்கப்பட்ட விதியுடன் பொருந்துகிறது.",
  "recheck.stillDiffers": "இந்த வரி இன்னும் சரிபார்க்கப்பட்ட விதியுடன் பொருந்தவில்லை.",
  "recheck.leave": "ஒற்றைக் கோப்புச் சோதனைக்குத் திரும்பு",
  "recheck.grids": "இரு கோப்புகளிலும் ஒவ்வொரு வரியும்",
  "recheck.gridNote": "அதே ஊழியர் இரு கட்டங்களிலும் ஒரே இடத்தில் இருக்கிறார்.",
  "recheck.STILL_MATCHED": "இரு முறையும் பொருந்தியது",
  "recheck.RESOLVED": "இப்போது பொருந்துகிறது",
  "recheck.STILL_EXCEPTION": "இன்னும் வேறுபடுகிறது",
  "recheck.NEW_EXCEPTION": "இப்போது வேறுபடுகிறது, முன்பு பொருந்தியது",
  "recheck.NEWLY_REFUSED": "முன்பு சரிபார்க்க முடிந்தது, இப்போது முடியாது",
  "recheck.STILL_REFUSED": "இரு முறையும் சரிபார்க்கப்படவில்லை",
  "recheck.NEWLY_CHECKED_MATCHED": "இம்முறை சரிபார்க்கப்பட்டது, பொருந்தியது",
  "recheck.NEWLY_CHECKED_EXCEPTION": "இம்முறை சரிபார்க்கப்பட்டது, வேறுபடுகிறது",
  "recheck.REMOVED": "முதல் கோப்பில் மட்டும்",
  "recheck.ADDED": "திருத்திய கோப்பில் மட்டும்",
  /* ---------------------------------------------------------- report studio */
  "report.heading": "மறுஆய்வுத் தொகுப்பை உருவாக்கு",
  "report.open": "மறுஆய்வுத் தொகுப்பை உருவாக்கு",
  "report.leave": "ஊதிய எக்ஸ்-ரே-க்குத் திரும்பு",
  "report.audience": "யார் படிப்பார்",
  "report.execName": "நிர்வாகம்",
  "report.execHint": "ஒரு பக்கம். என்ன சரிபார்க்கப்பட்டது, எவ்வளவு, எந்த வகை.",
  "report.opsName": "ஊதியப் பணிக்குழு",
  "report.opsHint": "கவனிக்க வேண்டிய ஒவ்வொரு வரியும்.",
  "report.auditName": "தணிக்கை / மறுஆய்வு",
  "report.auditHint": "பரப்பு, முறை, சரிபார்க்கப்பட்ட ஒவ்வொரு வரியும்.",
  "report.customName": "தனிப்பயன்",
  "report.customHint": "பகுதிகளை நீங்களே தேர்ந்தெடுங்கள்.",
  "report.modules": "பகுதிகள்",
  "report.alwaysIncluded": "எப்போதும் சேர்க்கப்படும். தொகுப்பில் உள்ள ஒவ்வொரு எண்ணும் சரிபார்க்கப்பட்ட வரிகள் பற்றியது.",
  "report.needsRecheck": "திருத்திய கோப்பு சரிபார்க்கப்பட்ட பிறகு கிடைக்கும்.",
  "report.privacy": "அடையாளம்",
  "report.privAnon": "வரி எண்கள் மட்டும்",
  "report.privAnonHint": "பெயரும் இல்லை, கணக்கு எண்ணும் இல்லை.",
  "report.privAccount": "மறைக்கப்பட்ட கணக்கு எண்",
  "report.privAccountHint": "உங்கள் அமைப்பில் வரியைக் கண்டறியப் போதுமானது.",
  "report.privFull": "பெயர்களும் கணக்கு எண்களும்",
  "report.privFullHint": "பதிவேற்றிய கோப்பில் இருந்தபடியே.",
  "report.take": "எடுத்துச் செல்",
  "report.print": "அச்சிடு / PDF ஆகச் சேமி",
  "report.excel": "Excel பணிப்புத்தகம் (.xlsx)",
  "report.preparing": "தயாராகிறது…",
  "report.json": "JSON",
  "report.csv": "CSV",
  "report.csvExceptions": "விதிவிலக்குகள் மட்டும்",
  "report.csvNotChecked": "சரிபார்க்கப்படாதவை",
  "report.csvAll": "அனைத்து வரிகளும்",
  "report.csvRows": "{n} வரிகள்",
  "report.csvDownload": "CSV பதிவிறக்கு",
  "report.advanced": "மேம்பட்டவை",
  "report.markdown": "Markdown",
  ...
  "focus.back": "பின்",
  "focus.skip": "இப்போதைக்கு விடு",
  "focus.next": "அடுத்து",
  "focus.allAnswered": "எல்லாவற்றுக்கும் பதில் அளிக்கப்பட்டுவிட்டது.",
  "focus.allAnsweredNote": "உங்கள் ஆவணங்களிலிருந்து {t}-இல் {n} உண்மைகள் உறுதி; மீதியை நீங்கள் அளித்துள்ளீர்கள்.",
  /* ------------------------------------------------------------ result lenses */
  "lens.summary": "சுருக்கம்",
  "lens.trail": "பணத்தின் பாதை",
  "lens.evidence": "சான்று",
  "lens.next": "அடுத்து என்ன",
  "lens.pick": "எதைப் பார்ப்பது",
  /* ------------------------------------------------------- the evidence pack */
  "pack.heading": "இதை உடன் எடுத்துச் செல்லுங்கள்",
  ...
  "pack.json": "தரவைப் பதிவிறக்கு",
  "pack.notTitle": "இது என்ன அல்ல",
  "pack.notClaim": "இது ஒரு கோரிக்கை அல்ல. எதுவும் தாக்கல் செய்யப்படவில்லை; FairSlip எதையும் தாக்கல் செய்வதில்லை.",
  "pack.notProof": "இது சான்று அல்ல. இது உங்கள் சொந்த ஆவணங்கள், படிக்கப்பட்டு, வெளியிடப்பட்ட விதிகள் பயன்படுத்தப்பட்டவை.",
