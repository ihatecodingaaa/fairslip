...
const zh: Partial<Record<Key, string>> = {
  ...
  "stage.reached": "已完成",
  "stage.notReached": "尚未",
  "evidence.heading": "你手上的文件",
  "evidence.blurb":
    "一张照片就够。任何东西都不会被保存：图像在这一次请求内被读取，然后丢弃。",
  "evidence.replace": "更换",
  "evidence.choose": "选择一张照片",
  "evidence.chosen": "已选择",
...
const bn: Partial<Record<Key, string>> = {
  ...
  "evidence.heading": "আপনার হাতে যে কাগজ আছে",
  "evidence.blurb":
  ...
  "evidence.choose": "একটি ছবি বাছুন",
  "evidence.chosen": "বেছে নেওয়া হয়েছে",
...
const ta: Partial<Record<Key, string>> = {
  ...
  "evidence.heading": "உங்கள் கையில் உள்ள ஆவணங்கள்",
  "evidence.blurb":
  ...
  "evidence.choose": "ஒரு படத்தைத் தேர்ந்தெடு",
  "evidence.chosen": "தேர்ந்தெடுக்கப்பட்டது",
